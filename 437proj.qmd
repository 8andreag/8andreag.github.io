...
| [tidyr](https://tidyr.tidyverse.org/)                                       |   for organizing data                                            |
| [recipes](https://cran.r-project.org/web/packages/recipes/index.html)                                       |         data processing                                      |
| [nnet](https://cran.r-project.org/web/packages/nnet/index.html)                                   |  for fitting multinomial logistic regression models                                           |
| [broom](https://cran.r-project.org/web/packages/broom/index.html)                                         |   Tidying the output of models and PCA                                            |
